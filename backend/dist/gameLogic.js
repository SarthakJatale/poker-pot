...
class GameLogic {
    static createInitialGameState(initialBetAmount) {
        return {
            currentRound: 1,
            currentTurn: 0,
            pot: 0,
    ...
    static processPlayerAction(room, action) {
    ...
    static updatePlayerBalance(room, playerId, newBalance) {
    ...
    static updateRoomSettings(room, settings) {
